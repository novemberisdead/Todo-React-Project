...
function Logo() {
    return (
        <svg className="w-10 h-10 border-black text-gray-800 dark:text-white text-opacity-20 shadow-md shadow-black rounded-md " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="black" fillOpacity='80%'  viewBox="0 0 24 24">
